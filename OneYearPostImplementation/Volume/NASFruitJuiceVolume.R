...
# anova(ARIMA,update(ARIMA,correlation=corARMA(q=19,form=~Time|Indicator)))
# 
# ###############################################################################
...
NASFruitJuice <- gls(Model, data=SDIL, correlation=corARMA(p=4, form=~Time|Indicator),method="ML")

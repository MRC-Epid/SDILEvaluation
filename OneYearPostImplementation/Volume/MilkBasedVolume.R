...
# anova(ARIMA,update(ARIMA,correlation=corARMA(p=3, q=3,form=~Time|Indicator))) #NON CONVERGENCE ERROR
...
MilkBased <- gls(Model, data=SDIL, correlation=corARMA(p=4,q=4, form=~Time|Indicator),method="ML")

###############################################################################
#CALCULATE STANDARD ERRORS FOR ANNOUNCEMENT AND IMPLEMENTATION
#DAVID PELL
#22/01/2020
###############################################################################
#ANNOUNCEMENT AND IMPLEMENTATION ABSOLUTE STANDARD ERROR ONLY INCLUDES THE FOLLOWING TERMS: 
#SDILAnnouncement
#AnnouncementIndicatorLevel
#AnnouncementTrend
#AnnouncementIndicatorTrend
#SDILImplmentation
#ImplementationTrend
...
AbsoluteChangeAILowerTier.fun <- function(model,n=1, TimePointI1=264, TimePointI2=257){
...
AbsDiffAnnouncementImplementation <- YWith - YWithout
...
LowerCIAnnouncementImplementation <- (AbsDiffAnnouncementImplementation - 1.96 * sqrt(VarWith - VarWithout))

###############################################################################
#ABSOLUTE DIFFERENCE BETWEEN COUNTERFACTUAL AND INTERVENTION - UPPER CI
###############################################################################

UpperCIAnnouncementImplementation <- (AbsDiffAnnouncementImplementation + 1.96 * sqrt(VarWith - VarWithout))

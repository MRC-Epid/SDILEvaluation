...
#24 HAS HIGHER BIC BUT 1 IS A SIMPLER MODEL AND HAS A HIGH BIC AND THE HIGHEST AIC
###############################################################################

HigherTierSugar <- gls(Model, data=SDIL, correlation=corARMA(p=1, form=~Time|Indicator),method="ML")

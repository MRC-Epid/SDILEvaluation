...
SDIL$sugar <- ifelse(SDIL$SDIL2=="MilkBased",(SDIL$sugar/1000),SDIL$sugar)
...
MilkBasedSugar <- gls(sugar ~ Time + Indicator + IndicatorTime + Level + Trend + I(IndicatorTrend*IndicatorTrend) +
                  IndicatorLevel + IndicatorTrend + AverageMonthlyTemperature + December +
                  January, data=SDIL,correlation=corARMA(p=8,form=~Time|Indicator),method="ML")

...
SDIL$sugar <- ifelse(SDIL$SDIL2=="LowSugar",(SDIL$sugar/100),SDIL$sugar)
...
LowSugarSugar <- gls(sugar ~ Time + Indicator + IndicatorTime + Level + Trend + I(IndicatorTrend*IndicatorTrend) +

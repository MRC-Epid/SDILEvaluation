...
SDIL <- WeeklyVolume[WeeklyVolume$SDIL2=="Powder"]
...
SDIL$sugar <- ifelse(SDIL$SDIL2=="Powder",(SDIL$sugar/100),SDIL$sugar)
...
# ###############################################################################
# 
# summary(lm(sugar ~ Time + Indicator + IndicatorTime + Level + Trend + IndicatorLevel + 
#        I(IndicatorTrend * IndicatorTrend) + IndicatorTrend + AverageMonthlyTemperature + December +
...
# ###############################################################################
# 
# model_ols <- lm(sugar ~ Time + Indicator + IndicatorTime + Level + Trend + IndicatorLevel + 
#                   IndicatorTrend + AverageMonthlyTemperature + December +
#                   January, data=SDIL)
# 
# ###############################################################################
...
# anova(ARIMA,update(ARIMA,correlation=corARMA(q=5,form=~Time|Indicator))) 
...
PowderSugar <- gls(sugar ~ Time + Indicator + IndicatorTime + Level + Trend + IndicatorLevel + 
                     IndicatorTrend + AverageMonthlyTemperature + December +
                     January, data=SDIL,correlation=corARMA(p=5,form=~Time|Indicator),method="ML")
